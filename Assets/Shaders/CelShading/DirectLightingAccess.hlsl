...
// {
//     HDShadowData dat;
//     return EvalShadow_WorldToShadow(dat, worldPos, false);
// }
	...
	out float DistanceAtten, out float ShadowAtten)
{
    ...
    ShadowAtten = 1.0f;
#else
    //float4 shadowCoord = EvalShadow_WorldToShadow(WorldPos, false);
    Light mainLight = GetAdditionalLightData(0);
	...
	out half DistanceAtten, out half ShadowAtten)
{
    ...
    ShadowAtten = 1.0f;
#else
    //half4 shadowCoord = EvalShadow_WorldToShadow(WorldPos, false);
