...
public class RealToonShaderGUI_HDRP_SRP : ShaderGUI
{
    ...
    string[] TOTIPS =
    {
        ...
        //Use Vertex Color As Normal Direction [68] [Outline]
                ...
                if (_N_F_O.floatValue == 1)
                {
                    ...
                    if (ShowOutline)
                    {
                        ...
                        if (UseSSOL == true)
                        {
                            ...
                            GUILayout.Space(10);
                            materialEditor.ShaderProperty(_UVCAND, new GUIContent(_UVCAND.displayName, TOTIPS[68]));
    ...
    void REMO_OUTL()
    {
        if (remoout == true)
        {
            ChanLi("Tags{}", "Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Assets/RealToon/RealToon Shaders/Version 5/HDRP/Default/D_Default_HDRP.shader");
        ...
        {
            ChanLi("Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Tags{}", "Assets/RealToon/RealToon Shaders/Version 5/HDRP/Default/D_Default_HDRP.shader");
            ChanLi("//Cull [_DoubleSidedOutline]//OL_RCUL", "Cull [_DoubleSidedOutline]//OL_RCUL", "Assets/RealToon/RealToon Shaders/Version 5/HDRP/Default/D_Default_HDRP.shader");
