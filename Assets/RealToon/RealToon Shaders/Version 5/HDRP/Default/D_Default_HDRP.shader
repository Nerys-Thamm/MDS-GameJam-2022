...
//
//		Finally SSR (Screen Space Reflection) and Raytracing has been added/supported, i started working on it on August 2020
//		and finished it on september 2020.
//		RealToon HDRP supports Raytracing Reflection, Raytracing Global Illumination and Raytracing Shadow.
//      
//      RealToon HDRP is finally "SRP Batcher" compatible.
//
//      SSGI (Screen Space Global Illumination) & Recursive Rendering is now finally added to RealToon HDRP, i started working on it on December 2020
//      and finally finished it on January 2021.
//      
//      Added Screen Space Ouline, it is actually an Edge Detection Outline but on the shader, not Post Processing.
//      I stared working on it on January 2021 and finished it on febuary 2021.
//
//		**Currently Unity Raytracing is still in preview.		
//
//		( MJQ Studio Works [PH] )
//
...
Shader "HDRP/RealToon/Version 5/Default"
{
    Properties
    {
        ...
        [HDR] _MainColor ("Main Color", Color) = (0.2352941,0.2352941,0.2352941,1.0)
		...
		[Toggle(N_F_AL_ON)] _N_F_AL ("Enable Area Light [Beta]", Float ) = 0.0
